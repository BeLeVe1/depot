...
<body style="width: 100%;padding-left:0%;">
	...
	<tr>
		...
		<div class="row cl" style="padding-top:2%;padding-left:10%;">
			...
			<div class="formControls col-xs-4 col-sm-6">
				<input type="text" class="input-text"   value="${dataprocess.clientNum}" placeholder="" id="clientNum" name="clientNum">
			</div>
		</div>
		</td>
<!-- 		<td> -->
...
function sub(){
    ...
    if(forms.clientNum.value==""){
    	layer.msg('信息不完整！');
    	return false;
    }
    if(forms.clientName.value==""){
    	layer.msg('信息不完整！');
    	return false;
    }
    $.ajax( {  
        type : 'POST',  
        url : 'adminfd_clientaddajax',  
        data : params,  
