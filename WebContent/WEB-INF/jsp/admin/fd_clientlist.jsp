...
<body>
	...
	<div class="cl pd-5 bg-1 bk-gray mt-10">
		<span class="l" style="margin-left:5px;margin-top:1%;">
			<button onclick="open_layer('信息添加','adminfd_clientadd','900','450')" href="javascript:;" class="btn btn-success" style="background-color: #337AB7;" type="submit"></i><i class="Hui-iconfont">&#xe645;</i> 添加客户信息</button>
<!-- 			<button onclick="Excelbutton();" class="btn btn-success" style="background-color: #337AB7;" type="submit"></i><i class="Hui-iconfont">&#xe644;</i> 备份</button> -->
		...
		<div class="text-c" style="margin-top:1%;">
		    <input type="text" name="bdcode" id="bdcode" placeholder="客户名称" style="width:100px" class="input-text">
			<input type="text" name="jqcode" id="jqcode" placeholder="客户编号" style="width:100px" class="input-text">
		...
		<div style="width: 98%; margin-left: 10px">
			<table id="example" class="table table-striped table-bordered">
				<thead>
					<tr>
						 <th style="text-align: center;width: 1%">客户编号</th>
	     ...
	     $('#example').DataTable( {
	        "ajax":{
		        ...
		        "columns": [        
				    	...
				    	{ "data": "clientNum" },
		            { "data": function(obj){
		                	return "<span><center><a onclick=\"open_layer('编辑','adminfd_clientreset?clientNum="+obj.clientNum+"','500','350')\">编辑</a>&nbsp;<a onclick=\"deleteobj("+obj.clientNum+")\">删除</a></center></span>"
		                	}
		                 }
		        			],
		        "columnDefs": [
