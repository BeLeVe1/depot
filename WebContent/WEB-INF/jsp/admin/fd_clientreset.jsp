...
<body style="width: 100%;padding-left:0%;">
	...
	<tr>
		...
		<div class="row cl" style="padding-top:2%;display:none">
			<label class="form-label col-xs-4 col-sm-2">clientNum：</label>
			<div class="formControls col-xs-7 col-sm-9">
				<input type="text" class="input-text" value="${clientNum}" placeholder="" id="clientNum" name="clientNum"> 
			</div>
		</div>
		<div class="row cl" style="padding-top:2%;padding-left:10%;">
			<label class="form-label col-xs-4 col-sm-4">客户名称：</label>
			<div class="formControls col-xs-4 col-sm-6">
				<input type="text" class="input-text"  value="${dataprocess.clientName}" placeholder="" id="clientName" name="clientName">
			</div>
		</div>
		<div class="row cl" style="padding-top:2%;padding-left:10%;">
			<label class="form-label col-xs-4 col-sm-4">客户编号：</label>
			<div class="formControls col-xs-4 col-sm-6">
				<input type="text" class="input-text"  disabled="disabled" value="${dataprocess.clientNum}" placeholder="" id="clientNum" name="clientNum">
			</div>
		</div>
