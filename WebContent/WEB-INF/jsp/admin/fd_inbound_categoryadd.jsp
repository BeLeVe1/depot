	...
	<tr>
		...
		<div class="row cl" style="padding-top:2%;padding-left:10%;">
			...
			<div class="formControls col-xs-4 col-sm-6">
				<input type="text" class="input-text"   value="${dataprocess.inbound_categoryNum}" placeholder="" id="inbound_categoryNum" name="inbound_categoryNum">
			</div>
		</div>
		<div class="row cl" style="padding-top:2%;padding-left:10%;">
...
function sub(){
    ...
    if(forms.inbound_categoryNum.value==""){
    	layer.msg('信息不完整！');
    	return false;
    }
    if(forms.inbound_categoryName.value==""){
    	layer.msg('信息不完整！');
    	return false;
    }
    $.ajax( {  
        type : 'POST',  
        url : 'adminfd_inbound_categoryaddajax',  
        data : params,  
