...
<body style="width: 100%;padding-left:0%;">
	...
	<tr>
		...
		<div class="row cl" style="padding-top:2%;display:none">
			<label class="form-label col-xs-4 col-sm-2">inbound_categoryNum：</label>
			<div class="formControls col-xs-7 col-sm-9">
				<input type="text" class="input-text" value="${inbound_categoryNum}" placeholder="" id="inbound_categoryNum" name="inbound_categoryNum"> 
			</div>
		</div>
		<div class="row cl" style="padding-top:2%;padding-left:10%;">
			<label class="form-label col-xs-4 col-sm-4">入库类别编号：</label>
			<div class="formControls col-xs-4 col-sm-6">
				<input type="text" class="input-text"  disabled="disabled" value="${dataprocess.inbound_categoryNum}" placeholder="" id="inbound_categoryNum" name="inbound_categoryNum">
			</div>
		</div>
		<div class="row cl" style="padding-top:2%;padding-left:10%;">
			<label class="form-label col-xs-4 col-sm-4">入库类别名称：</label>
			<div class="formControls col-xs-4 col-sm-6">
				<input type="text" class="input-text"  value="${dataprocess.inbound_categoryName}" placeholder="" id="inbound_categoryName" name="inbound_categoryName">
			</div>
		</div>
...
//     }
    ...
    $.ajax( {  
        type : 'POST',  
        url : 'adminfd_inbound_categoryresetajax',  
        data : params,  
