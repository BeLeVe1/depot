	...
	<tr>
		...
		<div class="row cl" style="padding-top:2%;padding-left:10%;">
			...
			<div class="formControls col-xs-4 col-sm-6">
				<input type="text" class="input-text"   value="${dataprocess.inbound_purchaseNum}" placeholder="" id="inbound_purchaseNum" name="inbound_purchaseNum">
			</div>
		</div>
		<div class="row cl" style="padding-top:2%;padding-left:10%;">
...
function sub(){
    ...
    if(forms.inbound_purchaseNum.value==""){
    	layer.msg('信息不完整！');
    	return false;
    }
    if(forms.inbound_purchaseName.value==""){
    	layer.msg('信息不完整！');
    	return false;
    }
    $.ajax( {  
        type : 'POST',  
        url : 'adminfd_inbound_purchaseaddajax',  
        data : params,  
