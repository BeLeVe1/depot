...
<body style="width: 100%;padding-left:0%;">
	...
	<tr>
		...
		<div class="row cl" style="padding-top:2%;display:none">
			<label class="form-label col-xs-4 col-sm-2">inbound_purchaseNum：</label>
			<div class="formControls col-xs-7 col-sm-9">
				<input type="text" class="input-text" value="${inbound_purchaseNum}" placeholder="" id="inbound_purchaseNum" name="inbound_purchaseNum"> 
			</div>
		</div>
		<div class="row cl" style="padding-top:2%;padding-left:10%;">
			<label class="form-label col-xs-4 col-sm-4">采购类型编号：</label>
			<div class="formControls col-xs-4 col-sm-6">
				<input type="text" class="input-text"  disabled="disabled" value="${dataprocess.inbound_purchaseNum}" placeholder="" id="inbound_purchaseNum" name="inbound_purchaseNum">
			</div>
		</div>
		<div class="row cl" style="padding-top:2%;padding-left:10%;">
			<label class="form-label col-xs-4 col-sm-4">采购类型名称：</label>
			<div class="formControls col-xs-4 col-sm-6">
				<input type="text" class="input-text"  value="${dataprocess.inbound_purchaseName}" placeholder="" id="inbound_purchaseName" name="inbound_purchaseName">
			</div>
		</div>
...
//     }
    ...
    $.ajax( {  
        type : 'POST',  
        url : 'adminfd_inbound_purchaseresetajax',  
        data : params,  
