	...
	<tr>
		...
		<div class="row cl" style="padding-top:2%;padding-left:10%;">
			...
			<div class="formControls col-xs-4 col-sm-6">
				<input type="text" class="input-text"   value="${dataprocess.outbound_categoryNum}" placeholder="" id="outbound_categoryNum" name="outbound_categoryNum">
			</div>
		</div>
		<div class="row cl" style="padding-top:2%;padding-left:10%;">
...
function sub(){
    ...
    if(forms.outbound_categoryNum.value==""){
    	layer.msg('信息不完整！');
    	return false;
    }
    if(forms.outbound_categoryName.value==""){
    	layer.msg('信息不完整！');
    	return false;
    }
    $.ajax( {  
        type : 'POST',  
        url : 'adminfd_outbound_categoryaddajax',  
        data : params,  
