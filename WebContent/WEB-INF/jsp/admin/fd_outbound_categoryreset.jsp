...
<body style="width: 100%;padding-left:0%;">
	...
	<tr>
		...
		<div class="row cl" style="padding-top:2%;display:none">
			<label class="form-label col-xs-4 col-sm-2">outbound_categoryNum：</label>
			<div class="formControls col-xs-7 col-sm-9">
				<input type="text" class="input-text" value="${outbound_categoryNum}" placeholder="" id="outbound_categoryNum" name="outbound_categoryNum"> 
			</div>
		</div>
		<div class="row cl" style="padding-top:2%;padding-left:10%;">
			<label class="form-label col-xs-4 col-sm-4">出库类别编号：</label>
			<div class="formControls col-xs-4 col-sm-6">
				<input type="text" class="input-text"  disabled="disabled" value="${dataprocess.outbound_categoryNum}" placeholder="" id="outbound_categoryNum" name="outbound_categoryNum">
			</div>
		</div>
		<div class="row cl" style="padding-top:2%;padding-left:10%;">
			<label class="form-label col-xs-4 col-sm-4">出库类别名称：</label>
			<div class="formControls col-xs-4 col-sm-6">
				<input type="text" class="input-text"  value="${dataprocess.outbound_categoryName}" placeholder="" id="outbound_categoryName" name="outbound_categoryName">
			</div>
		</div>
...
//     }
    ...
    $.ajax( {  
        type : 'POST',  
        url : 'adminfd_outbound_categoryresetajax',  
        data : params,  
