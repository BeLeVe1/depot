	...
	<tr>
		...
		<div class="row cl" style="padding-top:2%;padding-left:10%;">
			...
			<div class="formControls col-xs-4 col-sm-6">
				<input type="text" class="input-text"   value="${dataprocess.outbound_item_propertiesNum}" placeholder="" id="outbound_item_propertiesNum" name="outbound_item_propertiesNum">
			</div>
		</div>
		<div class="row cl" style="padding-top:2%;padding-left:10%;">
...
function sub(){
    ...
    if(forms.outbound_item_propertiesNum.value==""){
    	layer.msg('信息不完整！');
    	return false;
    }
    if(forms.outbound_item_propertiesName.value==""){
    	layer.msg('信息不完整！');
    	return false;
    }
    $.ajax( {  
        type : 'POST',  
        url : 'adminfd_outbound_item_propertiesaddajax',  
        data : params,  
