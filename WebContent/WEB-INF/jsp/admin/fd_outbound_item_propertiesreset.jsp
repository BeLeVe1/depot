...
<body style="width: 100%;padding-left:0%;">
	...
	<tr>
		...
		<div class="row cl" style="padding-top:2%;display:none">
			<label class="form-label col-xs-4 col-sm-2">outbound_item_propertiesNum：</label>
			<div class="formControls col-xs-7 col-sm-9">
				<input type="text" class="input-text" value="${outbound_item_propertiesNum}" placeholder="" id="outbound_item_propertiesNum" name="outbound_item_propertiesNum"> 
			</div>
		</div>
		<div class="row cl" style="padding-top:2%;padding-left:10%;">
			<label class="form-label col-xs-4 col-sm-4">项目属性编号：</label>
			<div class="formControls col-xs-4 col-sm-6">
				<input type="text" class="input-text"  disabled="disabled" value="${dataprocess.outbound_item_propertiesNum}" placeholder="" id="outbound_item_propertiesNum" name="outbound_item_propertiesNum">
			</div>
		</div>
		<div class="row cl" style="padding-top:2%;padding-left:10%;">
			<label class="form-label col-xs-4 col-sm-4">项目属性名称：</label>
			<div class="formControls col-xs-4 col-sm-6">
				<input type="text" class="input-text"  value="${dataprocess.outbound_item_propertiesName}" placeholder="" id="outbound_item_propertiesName" name="outbound_item_propertiesName">
			</div>
		</div>
...
//     }
    ...
    $.ajax( {  
        type : 'POST',  
        url : 'adminfd_outbound_item_propertiesresetajax',  
        data : params,  
