	...
	<tr>
		...
		<div class="row cl" style="padding-top:2%;padding-left:10%;">
			...
			<div class="formControls col-xs-4 col-sm-6">
				<input type="text" class="input-text"   value="${dataprocess.outbusinessNum}" placeholder="" id="outbusinessNum" name="outbusinessNum">
			</div>
		</div>
		<div class="row cl" style="padding-top:2%;padding-left:10%;">
...
function sub(){
    ...
    if(forms.outbusinessNum.value==""){
    	layer.msg('信息不完整！');
    	return false;
    }
    if(forms.outbusinessName.value==""){
    	layer.msg('信息不完整！');
    	return false;
    }
    $.ajax( {  
        type : 'POST',  
        url : 'adminfd_outbusinessaddajax',  
        data : params,  
