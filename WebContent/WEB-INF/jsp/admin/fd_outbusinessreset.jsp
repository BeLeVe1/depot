...
<body style="width: 100%;padding-left:0%;">
	...
	<tr>
		...
		<div class="row cl" style="padding-top:2%;display:none">
			<label class="form-label col-xs-4 col-sm-2">outbusinessNum：</label>
			<div class="formControls col-xs-7 col-sm-9">
				<input type="text" class="input-text" value="${outbusinessNum}" placeholder="" id="outbusinessNum" name="outbusinessNum"> 
			</div>
		</div>
		<div class="row cl" style="padding-top:2%;padding-left:10%;">
			<label class="form-label col-xs-4 col-sm-4">业务编号：</label>
			<div class="formControls col-xs-4 col-sm-6">
				<input type="text" class="input-text"  disabled="disabled" value="${dataprocess.outbusinessNum}" placeholder="" id="outbusinessNum" name="outbusinessNum">
			</div>
		</div>
		<div class="row cl" style="padding-top:2%;padding-left:10%;">
			<label class="form-label col-xs-4 col-sm-4">业务名称：</label>
			<div class="formControls col-xs-4 col-sm-6">
				<input type="text" class="input-text"  value="${dataprocess.outbusinessName}" placeholder="" id="outbusinessName" name="outbusinessName">
			</div>
		</div>
...
//     }
    ...
    $.ajax( {  
        type : 'POST',  
        url : 'adminfd_outbusinessresetajax',  
        data : params,  
