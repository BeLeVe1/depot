	...
	<tr>
		...
		<div class="row cl" style="padding-top:2%;padding-left:10%;">
			...
			<div class="formControls col-xs-4 col-sm-6">
				<input type="text" class="input-text"   value="${dataprocess.perNum}" placeholder="" id="perNum" name="perNum">
			</div>
		</div>
		<div class="row cl" style="padding-top:2%;padding-left:10%;">
...
function sub(){
    ...
    if(forms.perNum.value==""){
    	layer.msg('员工信息不完整！');
    	return false;
    }
    if(forms.perName.value==""){
    	layer.msg('员工信息不完整！');
    	return false;
    }
