...
<body style="width: 100%;padding-left:0%;">
	...
	<tr>
		...
		<div class="row cl" style="padding-top:2%;display:none">
			<label class="form-label col-xs-4 col-sm-2">perNum：</label>
			<div class="formControls col-xs-7 col-sm-9">
				<input type="text" class="input-text" value="${perNum}" placeholder="" id="perNum" name="perNum"> 
			</div>
		</div>
		<div class="row cl" style="padding-top:2%;padding-left:10%;">
			<label class="form-label col-xs-4 col-sm-4">员工编号：</label>
			<div class="formControls col-xs-4 col-sm-6">
				<input type="text" class="input-text" disabled="disabled"  value="${dataprocess.perNum}" placeholder="" id="perNum" name="perNum">
			</div>
		</div>
		<div class="row cl" style="padding-top:2%;padding-left:10%;">
			<label class="form-label col-xs-4 col-sm-4">员工姓名：</label>
			<div class="formControls col-xs-4 col-sm-6">
				<input type="text" class="input-text"  value="${dataprocess.perName}" placeholder="" id="perName" name="perName">
			</div>
		</div>
		<div class="row cl" style="padding-top:2%;padding-left:10%;">
		...
		<div class="row cl" style="padding-top:2%;padding-left:10%;">
			...
			<div class="formControls col-xs-4 col-sm-6">
				<input type="text" class="input-text" value="${dataprocess.perWork}" placeholder="" id="perWork" name="perWork">
			</div>
		</div>
		</td>
<!-- 		<td> -->
