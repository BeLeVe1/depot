...
<link id="easyuiTheme" rel="stylesheet" type="text/css" href="js/Hui-js/lib/jquery/jquery-easyui-1.4.5/themes/ui-pepspareparts-grinder/easyui.css" />
<!--[if IE 6]>
...
<body style="width: 100%;padding-left:0%;">
	...
	<tr>
		...
		<div class="row cl" style="padding-top:2%;padding-left:10%;">
			<label class="form-label col-xs-4 col-sm-4">备品备件编号：</label>
			<div class="formControls col-xs-4 col-sm-6">
				<input type="text" class="input-text"   value="${dataprocess.sparepartsNum}" placeholder="" id="sparepartsNum" name="sparepartsNum">
			</div>
		</div>
			<div class="row cl" style="padding-top:2%;padding-left:10%;">
			<label class="form-label col-xs-4 col-sm-4">备品备件类型：</label>
			<div class="formControls col-xs-4 col-sm-6">
				<input type="text" class="input-text"   value="${dataprocess.sparepartsType}" placeholder="" id="sparepartsType" name="sparepartsType">
			</div>
		</div>
			<div class="row cl" style="padding-top:2%;padding-left:10%;">
			<label class="form-label col-xs-4 col-sm-4">备品备件名称：</label>
			<div class="formControls col-xs-4 col-sm-6">
				<input type="text" class="input-text"   value="${dataprocess.sparepartsName}" placeholder="" id="sparepartsName" name="sparepartsName">
			</div>
		</div>
			<div class="row cl" style="padding-top:2%;padding-left:10%;">
			<label class="form-label col-xs-4 col-sm-4">备品备件型号：</label>
			<div class="formControls col-xs-4 col-sm-6">
				<input type="text" class="input-text"   value="${dataprocess.sparepartsSpecification}" placeholder="" id="sparepartsSpecification" name="sparepartsSpecification">
			</div>
		</div>
			<div class="row cl" style="padding-top:2%;padding-left:10%;">
			<label class="form-label col-xs-4 col-sm-4">备品备件库存：</label>
			<div class="formControls col-xs-4 col-sm-6">
				<input type="text" class="input-text"   value="${dataprocess.sparepartsStocks}" placeholder="" id="sparepartsStocks" name="sparepartsStocks">
			</div>
		</div>
			<div class="row cl" style="padding-top:2%;padding-left:10%;">
			<label class="form-label col-xs-4 col-sm-4">备品备件计量单位：</label>
			<div class="formControls col-xs-4 col-sm-6">
				<input type="text" class="input-text"   value="${dataprocess.sparepartsUnit}" placeholder="" id="sparepartsUnit" name="sparepartsUnit">
			</div>
		</div>
			<div class="row cl" style="padding-top:2%;padding-left:10%;">
			<label class="form-label col-xs-4 col-sm-4">备品备件单价：</label>
			<div class="formControls col-xs-4 col-sm-6">
				<input type="text" class="input-text"   value="${dataprocess.sparepartsPrice}" placeholder="" id="sparepartsPrice" name="sparepartsPrice">
			</div>
		</div>
...
function sub(){
    ...
    if(forms.sparepartsNum.value==""){
    	layer.msg('信息不完整！');
    	return false;
    }
    if(forms.sparepartsType.value==""){
    	layer.msg('信息不完整！');
    	return false;
    }
    if(forms.sparepartsName.value==""){
    	layer.msg('信息不完整！');
    	return false;
    }
    if(forms.sparepartsSpecification.value==""){
    	layer.msg('信息不完整！');
    	return false;
    }
    if(forms.sparepartsStocks.value==""){
    	layer.msg('信息不完整！');
    	return false;
    }
    if(forms.sparepartsUnit.value==""){
    	layer.msg('信息不完整！');
    	return false;
    }
    
    if(forms.sparepartsPrice.value==""){
    	layer.msg('信息不完整！');
    	return false;
    }
