	...
	<tr>
		...
		<div class="row cl" style="padding-top:2%;padding-left:10%;">
			...
			<div class="formControls col-xs-4 col-sm-6">
				<input type="text" class="input-text"   value="${dataprocess.warehouseNum}" placeholder="" id="warehouseNum" name="warehouseNum">
			</div>
		</div>
		<div class="row cl" style="padding-top:2%;padding-left:10%;">
...
function sub(){
    ...
    if(forms.warehouseNum.value==""){
    	layer.msg('信息不完整！');
    	return false;
    }
    if(forms.warehouseName.value==""){
    	layer.msg('信息不完整！');
    	return false;
    }
   
    if(forms.warehouseFreight.value==""){
    	layer.msg('信息不完整！');
    	return false;
    }
