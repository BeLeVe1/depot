...
<link id="easyuiTheme" rel="stylesheet" type="text/css" href="js/Hui-js/lib/jquery/jquery-easyui-1.4.5/themes/ui-pepwarehouse-grinder/easyui.css" />
<!--[if IE 6]>
...
<body style="width: 100%;padding-left:0%;">
	...
	<tr>
		...
		<div class="row cl" style="padding-top:2%;display:none">
			<label class="form-label col-xs-4 col-sm-2">warehouseNum：</label>
			<div class="formControls col-xs-7 col-sm-9">
				<input type="text" class="input-text" value="${warehouseNum}" placeholder="" id="warehouseNum" name="warehouseNum"> 
			</div>
		</div>
		<div class="row cl" style="padding-top:2%;padding-left:10%;">
			<label class="form-label col-xs-4 col-sm-4">仓库编号：</label>
			<div class="formControls col-xs-4 col-sm-6">
				<input type="text" class="input-text"  disabled="disabled" value="${dataprocess.warehouseNum}" placeholder="" id="warehouseNum" name="warehouseNum">
			</div>
		</div>
		<div class="row cl" style="padding-top:2%;padding-left:10%;">
			<label class="form-label col-xs-4 col-sm-4">仓库名称：</label>
			<div class="formControls col-xs-4 col-sm-6">
				<input type="text" class="input-text"  value="${dataprocess.warehouseName}" placeholder="" id="warehouseName" name="warehouseName">
			</div>
		</div>
		
		<div class="row cl" style="padding-top:2%;padding-left:10%;">
			<label class="form-label col-xs-4 col-sm-4">货位：</label>
			<div class="formControls col-xs-4 col-sm-6">
				<input type="text" class="input-text" value="${dataprocess.warehouseFreight}" placeholder="" id="warehouseFreight" name="warehouseFreight">
			</div>
		</div>
		</td>
<!-- 		<td> -->
...
//     }
    ...
    $.ajax( {  
        type : 'POST',  
        url : 'adminfd_warehouseresetajax',  
        data : params,  
