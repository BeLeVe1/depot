	...
	<tr>
		...
		<div class="row cl" style="padding-top:2%;padding-left:10%;">
			...
			<div class="formControls col-xs-4 col-sm-6">
				<input type="text" class="input-text"   value="${dataprocess.windfarmNum}" placeholder="" id="windfarmNum" name="windfarmNum">
			</div>
		</div>
		<div class="row cl" style="padding-top:2%;padding-left:10%;">
...
function sub(){
    ...
    if(forms.windfarmNum.value==""){
    	layer.msg('风场信息不完整！');
    	return false;
    }
    if(forms.windfarmName.value==""){
    	layer.msg('风场信息不完整！');
    	return false;
    }
  /*   if(forms.phoneNum.value==""){
    	layer.msg('风场信息不完整！');
    	return false;
    } */
    if(forms.windfarmRegion.value==""){
    	layer.msg('风场信息不完整！');
    	return false;
    }
