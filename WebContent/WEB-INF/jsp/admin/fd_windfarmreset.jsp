...
<body style="width: 100%;padding-left:0%;">
	...
	<tr>
		...
		<div class="row cl" style="padding-top:2%;display:none">
			<label class="form-label col-xs-4 col-sm-2">windfarmNum：</label>
			<div class="formControls col-xs-7 col-sm-9">
				<input type="text" class="input-text" value="${windfarmNum}" placeholder="" id="windfarmNum" name="windfarmNum"> 
			</div>
		</div>
		<div class="row cl" style="padding-top:2%;padding-left:10%;">
			<label class="form-label col-xs-4 col-sm-4">风场编号：</label>
			<div class="formControls col-xs-4 col-sm-6">
				<input type="text" class="input-text"  disabled="disabled" value="${dataprocess.windfarmNum}" placeholder="" id="windfarmNum" name="windfarmNum">
			</div>
		</div>
		<div class="row cl" style="padding-top:2%;padding-left:10%;">
			<label class="form-label col-xs-4 col-sm-4">风场名称：</label>
			<div class="formControls col-xs-4 col-sm-6">
				<input type="text" class="input-text"  value="${dataprocess.windfarmName}" placeholder="" id="windfarmName" name="windfarmName">
			</div>
		</div>
		<%-- <div class="row cl" style="padding-top:2%;padding-left:10%;">
			<label class="form-label col-xs-4 col-sm-4">电话号码：</label>
			<div class="formControls col-xs-4 col-sm-6">
				<input type="text" class="input-text" value="${dataprocess.phoneNum}" placeholder="" id="phoneNum" name="phoneNum">
			</div>
		</div> --%>
		<div class="row cl" style="padding-top:2%;padding-left:10%;">
			<label class="form-label col-xs-4 col-sm-4">所处区域：</label>
			<div class="formControls col-xs-4 col-sm-6">
				<input type="text" class="input-text" value="${dataprocess.windfarmRegion}" placeholder="" id="windfarmRegion" name="windfarmRegion">
			</div>
		</div>
		</td>
<!-- 		<td> -->
